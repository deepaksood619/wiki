...
Use Shadow fleets, group of hosts that have some applications and gets all the data but doen't serve any customer. Get request, calls all the same services as in production.





**Mapping (Graph problem)**
...
![つ の 。 ) フ び つ や ](media/System-Design---Uber-Lyft-ride-sharing-services-image2.png){width="5.0in" height="3.8958333333333335in"}
