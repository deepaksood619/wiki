...
![Authenticate Digital Identity RediSEirch geol on RedisGäiÆ Message Broker ](media/Microservice-Architecture_Example-image5.png)
...
![API Gateway Approve I Decüne payment Payment History ](media/Microservice-Architecture_Example-image6.png)
