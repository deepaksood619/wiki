...
![How Does BitTorrent Work? a Plain English Guide](media/TCP-(Connection-Oriented-Protocol)_Flow-Control-image7.png){width="5.0in" height="2.8229166666666665in"}<https://www.isi.edu/nsnam/DIRECTED_RESEARCH/DR_HYUNAH/D-Research/slow-start-tcp.html>
