...
![y In(x) dy SIO e clx d(ln(x)) dc dy ](media/Essence-of-Calculus---3Blue1Brown-image42.png){width="5.0in" height="3.125in"}-   Multivariate Calculus
7.  **Limits**
...
![](media/Essence-of-Calculus---3Blue1Brown-image46.png){width="5.0in" height="3.125in"}-   **L'Hôpital's rule**
...
![In(x) (x 1) Diverges" Radius of convergence" ](media/Essence-of-Calculus---3Blue1Brown-image87.png){width="5.0in" height="3.125in"}-   Lagrange error bounds
-   Convergence tests
