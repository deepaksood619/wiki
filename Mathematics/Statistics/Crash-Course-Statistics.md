...
![DISTRIBUTION COMPARISON Z-DISTRIBUTION (STANDARD NORMAL) T-DISTRIBUTION (N CLOSE TO 30) T-DISTRIBUTION (N SMALLER THAN 30) ](media/Crash-Course-Statistics-image3.png){width="5.0in" height="3.03125in"}-   Effect Size - Tells us how big the effect we observed was, compared to random variation.
...
![CALCULATING ETA SQUARED 272 = EFFECT TOTAL ERROR 2555364047 ](media/Crash-Course-Statistics-image12.png){width="5.0in" height="2.0729166666666665in"}-   ETA squared tells you the proportion of total variation tha's accounted for by your specific variable
-   Interaction
-   Two-way ANOVA
...
![ANOVA ΤΑΒΙΕ VARlABlE EXPERTISE ΒΟΤΤΙΕ ΤΥΡΕ EXPERTISE : ΒΟΤΤΙΕ ΤΥΡΕ ERROR 1.338 2.1622 7.9999 0.251743 0.145567 0.005979 76 477.6 774.2 2864.3 27211.4 477.6 774.2 2864.3 358.04 ](media/Crash-Course-Statistics-image17.png){width="5.0in" height="2.6458333333333335in"}-   Main Effects
