...
![Availability Zone 1 SQL Transactions Caching Availability Zone 2 SQL Transactions Caching Shared storage volume Storage nodes with SSDs Availability Zone 3 SQL Transactions Caching ](media/AWS-Aurora-image1.png){width="6.177083333333333in" height="4.114583333333333in"}-   Asynchronous Key Fetch
-   Batched Scans
**Views**
