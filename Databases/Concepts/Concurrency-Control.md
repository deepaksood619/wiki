    ...
    - There are two ways to deal with deadlocks in a two-phase locking (2PL) concurrency control protocol
        ...
        - **Deadlock Prevention**
            ...
            - If lock is not available, the txn will either
                ...
                - commit suicide
                - kill the other txn
![image](media/Concurrency-Control-image1.png)
...
![image](media/Concurrency-Control-image2.png)

2. **Write-intensive / Medium-contention**

![image](media/Concurrency-Control-image3.png)

3. **Write-intensive / High-contention**

![image](media/Concurrency-Control-image4.png)
