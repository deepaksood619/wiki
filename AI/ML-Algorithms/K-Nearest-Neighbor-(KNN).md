...
![image](media/K-Nearest-Neighbor-(KNN)-image1.png)

![image](media/K-Nearest-Neighbor-(KNN)-image2.png)

![image](media/K-Nearest-Neighbor-(KNN)-image3.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image4.png)

![image](media/K-Nearest-Neighbor-(KNN)-image5.png)

![image](media/K-Nearest-Neighbor-(KNN)-image6.png)

![image](media/K-Nearest-Neighbor-(KNN)-image7.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image8.png)

![image](media/K-Nearest-Neighbor-(KNN)-image9.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image10.png)

![image](media/K-Nearest-Neighbor-(KNN)-image11.png)

![image](media/K-Nearest-Neighbor-(KNN)-image12.png)

![image](media/K-Nearest-Neighbor-(KNN)-image13.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image15.jpeg)
...
![image](media/K-Nearest-Neighbor-(KNN)-image18.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image19.png)

![image](media/K-Nearest-Neighbor-(KNN)-image20.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image21.png)
...
![image](media/K-Nearest-Neighbor-(KNN)-image22.png)

![image](media/K-Nearest-Neighbor-(KNN)-image23.png)

![image](media/K-Nearest-Neighbor-(KNN)-image24.png)
